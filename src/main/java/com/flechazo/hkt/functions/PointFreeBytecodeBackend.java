    ...
    private record Compiler(MethodHandles.Lookup lookup) {
        ...
        private void emitInlineTraversalContainerModify(
            ...
            switch (traversal.containerKind()) {
                case GeneratedTraversalRuntime.LIST -> emitCollectionTraversal(
                        code,
                        functionSlot,
                        containerSlot,
                        replacementSlot,
                        CD_ARRAY_LIST);
                case GeneratedTraversalRuntime.SET -> emitCollectionTraversal(
                        code,
                        functionSlot,
                        containerSlot,
                        replacementSlot,
                ...
                case GeneratedTraversalRuntime.ARRAY -> emitArrayTraversal(
                        code,
                        functionSlot,
                        containerSlot,
                        replacementSlot,
